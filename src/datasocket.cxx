...
datasocket::datasocket(uint32_t detid,uint32_t sourceid,uint32_t max_size) : _detid(detid),_sourceid(sourceid),_memdir(""),_alive(false)
{ 
...
datasocket::datasocket(std::string name,uint32_t max_size) : _memdir(""),_alive(false)
{ 
...
bool datasocket::isAlive() {return _alive;}
